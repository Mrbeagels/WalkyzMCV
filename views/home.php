...
<div class="container-fluid py-5">
    <div class="row d-flex align-items-center justify-content-center">
        ...
        <div class="col-12 col-lg-7 d-flex flex-column justify-content-center text-center">
            ...
            <p>Notre communauté est basée sur le respect et le bien-être des chiens et des maîtres. L'entraide et le respect des membres sont primordiaux pour le bon déroulement de votre moment de complicité.</p>
        </div>
    </div>
</div>
